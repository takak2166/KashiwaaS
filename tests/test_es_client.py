...
class TestElasticsearchClient:
    ...
    def test_index_document(self, mock_elasticsearch):
        ...
        # Verify
        assert result is True
        mock_es_instance.index.assert_called_once_with(index="test-index", document=document, id="test-id")
...
class TestElasticsearchQuery:
    ...
    def test_bool_query(self):
        ...
        must_not_queries = [term_query("user_id", "U00000")]

        query = bool_query(must=must_queries, should=should_queries, must_not=must_not_queries)

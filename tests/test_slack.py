...
class TestSlackMessage:
    ...
    def test_from_slack_data(self):
        ...
        message_data = {
            ...
            "reactions": [{"name": "thumbsup", "count": 2, "users": ["U11111", "U22222"]}],
    ...
    def test_to_elasticsearch_doc(self):
        ...
        message = SlackMessage(
            ...
            thread_ts="1609459200.000000",
            reply_count=2,
            reactions=[SlackReaction(name="thumbsup", count=1, users=["U11111"])],
            mentions=["U67890"],
            attachments=[],
        )
...
class TestSlackClient:
    ...
    def test_get_messages(self):
        ...
        messages = list(client.get_messages(oldest=start_date, latest=end_date, limit=10, include_threads=True))
...
class TestSlackClientMock:
    ...
    def test_get_messages_mock(self, mock_web_client):
        ...
        mock_client.conversations_history.return_value = {
            ...
            "response_metadata": {"next_cursor": ""},  # No next page
        }
        ...
        # Get messages
        messages = list(client.get_messages(oldest=datetime(2021, 1, 1), latest=datetime(2021, 1, 2)))

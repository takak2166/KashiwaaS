...
def build_aggregation_query(
    ...
    """
    agg_query = {"size": size, "aggs": aggs}

    if query_parts:
        # Create a bool query with must clause
        agg_query["query"] = {"bool": {"must": query_parts}}
...
def date_histogram_aggregation(field: str, interval: str = "day", format: str = "yyyy-MM-dd") -> Dict[str, Any]:
    """
